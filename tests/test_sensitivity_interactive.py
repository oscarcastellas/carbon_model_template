#!/usr/bin/env python3
"""
Test Sensitivity Analysis Interactive Sheet Creation
"""
...
def test_create_interactive_sheet():
    ...
    print("=" * 70)
    print("TESTING INTERACTIVE SENSITIVITY ANALYSIS SHEET CREATION")
    print("=" * 70)
    print()
    
    # Create workbook
    output_file = "test_sensitivity_interactive.xlsx"
    workbook = xlsxwriter.Workbook(output_file)
    
    # Create interactive sheet
    print("1. Creating interactive sheet...")
    creator = InteractiveSensitivitySheet(workbook)
    assumptions = {
        'wacc': 0.08,
    ...
    if os.path.exists(output_file):
        ...
        try:
            ...
            if 'Sensitivity Interactive' in sheet_names:
    ...
    print("  2. Go to 'Sensitivity Interactive' sheet")
    print("  3. Set your input ranges (or use defaults)")
    print("  4. Run: python3 scripts/run_sensitivity_from_excel.py " + output_file)
