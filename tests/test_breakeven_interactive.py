#!/usr/bin/env python3
"""
Test Breakeven Interactive Sheet Creation
"""
...
def test_create_interactive_sheet():
    ...
    print("=" * 70)
    print("TESTING INTERACTIVE BREAKEVEN SHEET CREATION")
    print("=" * 70)
    print()
    
    # Create workbook
    output_file = "test_breakeven_interactive.xlsx"
    workbook = xlsxwriter.Workbook(output_file)
    
    # Create interactive sheet
    print("1. Creating interactive sheet...")
    creator = InteractiveBreakevenSheet(workbook)
    assumptions = {
        'wacc': 0.08,
    ...
    if os.path.exists(output_file):
        ...
        try:
            ...
            if 'Breakeven Interactive' in sheet_names:
    ...
    print("  2. Go to 'Breakeven Interactive' sheet")
    print("  3. Set your parameters (metric, target NPV, streaming %)")
    print("  4. Run: python3 scripts/run_breakeven_from_excel.py " + output_file)
